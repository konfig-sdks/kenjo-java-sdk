...
|**startDate** | **String** | The starting date of the employee in ISO format. |  [optional] |
...
|**weeklyHours** | **Double** | The number of weekly hours that an employee works. Combined with the work schedule allows to determine the day hours. This field is required and must be equals or greater than 1. |  [optional] |
