...
public class EmployeesGetEmployeeInformationResponseFinancial {
  ...
  public EmployeesGetEmployeeInformationResponseFinancial() {
  }

  public EmployeesGetEmployeeInformationResponseFinancial accountHolderName(String accountHolderName) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial bankName(String bankName) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial accountNumber(String accountNumber) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial iban(String iban) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial swiftCode(String swiftCode) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial nationalId(String nationalId) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial passport(String passport) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial nationalInsuranceNumber(String nationalInsuranceNumber) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial taxCode(String taxCode) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseFinancial taxIdentificationNumber(String taxIdentificationNumber) {
  ...
  **/
   ...
   * @return the EmployeesGetEmployeeInformationResponseFinancial instance itself
   */
  public EmployeesGetEmployeeInformationResponseFinancial putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesGetEmployeeInformationResponseFinancial employeesGetEmployeeInformationResponseFinancial = (EmployeesGetEmployeeInformationResponseFinancial) o;
    return Objects.equals(this.accountHolderName, employeesGetEmployeeInformationResponseFinancial.accountHolderName) &&
        Objects.equals(this.bankName, employeesGetEmployeeInformationResponseFinancial.bankName) &&
        Objects.equals(this.accountNumber, employeesGetEmployeeInformationResponseFinancial.accountNumber) &&
        Objects.equals(this.iban, employeesGetEmployeeInformationResponseFinancial.iban) &&
        Objects.equals(this.swiftCode, employeesGetEmployeeInformationResponseFinancial.swiftCode) &&
        Objects.equals(this.nationalId, employeesGetEmployeeInformationResponseFinancial.nationalId) &&
        Objects.equals(this.passport, employeesGetEmployeeInformationResponseFinancial.passport) &&
        Objects.equals(this.nationalInsuranceNumber, employeesGetEmployeeInformationResponseFinancial.nationalInsuranceNumber) &&
        Objects.equals(this.taxCode, employeesGetEmployeeInformationResponseFinancial.taxCode) &&
        Objects.equals(this.taxIdentificationNumber, employeesGetEmployeeInformationResponseFinancial.taxIdentificationNumber)&&
        Objects.equals(this.additionalProperties, employeesGetEmployeeInformationResponseFinancial.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesGetEmployeeInformationResponseFinancial {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesGetEmployeeInformationResponseFinancial
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesGetEmployeeInformationResponseFinancial.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesGetEmployeeInformationResponseFinancial is not found in the empty JSON string", EmployeesGetEmployeeInformationResponseFinancial.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesGetEmployeeInformationResponseFinancial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesGetEmployeeInformationResponseFinancial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesGetEmployeeInformationResponseFinancial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesGetEmployeeInformationResponseFinancial.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesGetEmployeeInformationResponseFinancial>() {
           @Override
           public void write(JsonWriter out, EmployeesGetEmployeeInformationResponseFinancial value) throws IOException {
           ...
           @Override
           public EmployeesGetEmployeeInformationResponseFinancial read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesGetEmployeeInformationResponseFinancial instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesGetEmployeeInformationResponseFinancial given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesGetEmployeeInformationResponseFinancial
  * @throws IOException if the JSON string is invalid with respect to EmployeesGetEmployeeInformationResponseFinancial
  */
  public static EmployeesGetEmployeeInformationResponseFinancial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesGetEmployeeInformationResponseFinancial.class);
  }

 /**
  * Convert an instance of EmployeesGetEmployeeInformationResponseFinancial to an JSON string
  *
  * @return JSON string
  */
