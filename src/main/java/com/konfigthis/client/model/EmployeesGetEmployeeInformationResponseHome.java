...
public class EmployeesGetEmployeeInformationResponseHome {
  ...
  public EmployeesGetEmployeeInformationResponseHome() {
  }

  public EmployeesGetEmployeeInformationResponseHome maritalStatus(String maritalStatus) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome spouseFirstName(String spouseFirstName) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome spouseLastName(String spouseLastName) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome spouseBirthdate(String spouseBirthdate) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome spouseGender(String spouseGender) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome personalEmail(String personalEmail) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome personalPhone(String personalPhone) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseHome personalMobile(String personalMobile) {
  ...
  **/
   ...
   * @return the EmployeesGetEmployeeInformationResponseHome instance itself
   */
  public EmployeesGetEmployeeInformationResponseHome putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesGetEmployeeInformationResponseHome employeesGetEmployeeInformationResponseHome = (EmployeesGetEmployeeInformationResponseHome) o;
    return Objects.equals(this.maritalStatus, employeesGetEmployeeInformationResponseHome.maritalStatus) &&
        Objects.equals(this.spouseFirstName, employeesGetEmployeeInformationResponseHome.spouseFirstName) &&
        Objects.equals(this.spouseLastName, employeesGetEmployeeInformationResponseHome.spouseLastName) &&
        Objects.equals(this.spouseBirthdate, employeesGetEmployeeInformationResponseHome.spouseBirthdate) &&
        Objects.equals(this.spouseGender, employeesGetEmployeeInformationResponseHome.spouseGender) &&
        Objects.equals(this.personalEmail, employeesGetEmployeeInformationResponseHome.personalEmail) &&
        Objects.equals(this.personalPhone, employeesGetEmployeeInformationResponseHome.personalPhone) &&
        Objects.equals(this.personalMobile, employeesGetEmployeeInformationResponseHome.personalMobile)&&
        Objects.equals(this.additionalProperties, employeesGetEmployeeInformationResponseHome.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesGetEmployeeInformationResponseHome {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesGetEmployeeInformationResponseHome
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesGetEmployeeInformationResponseHome.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesGetEmployeeInformationResponseHome is not found in the empty JSON string", EmployeesGetEmployeeInformationResponseHome.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesGetEmployeeInformationResponseHome.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesGetEmployeeInformationResponseHome' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesGetEmployeeInformationResponseHome> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesGetEmployeeInformationResponseHome.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesGetEmployeeInformationResponseHome>() {
           @Override
           public void write(JsonWriter out, EmployeesGetEmployeeInformationResponseHome value) throws IOException {
           ...
           @Override
           public EmployeesGetEmployeeInformationResponseHome read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesGetEmployeeInformationResponseHome instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesGetEmployeeInformationResponseHome given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesGetEmployeeInformationResponseHome
  * @throws IOException if the JSON string is invalid with respect to EmployeesGetEmployeeInformationResponseHome
  */
  public static EmployeesGetEmployeeInformationResponseHome fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesGetEmployeeInformationResponseHome.class);
  }

 /**
  * Convert an instance of EmployeesGetEmployeeInformationResponseHome to an JSON string
  *
  * @return JSON string
  */
