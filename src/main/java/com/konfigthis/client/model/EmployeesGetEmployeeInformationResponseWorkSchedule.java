...
public class EmployeesGetEmployeeInformationResponseWorkSchedule {
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule() {
  }

  public EmployeesGetEmployeeInformationResponseWorkSchedule mondayWorkingDay(Boolean mondayWorkingDay) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule tuesdayWorkingDay(Boolean tuesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule wednesdayWorkingDay(Boolean wednesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule thursdayWorkingDay(Boolean thursdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule fridayWorkingDay(Boolean fridayWorkingDay) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule saturdayWorkingDay(Boolean saturdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWorkSchedule sundayWorkingDay(Boolean sundayWorkingDay) {
  ...
  **/
   ...
   * @return the EmployeesGetEmployeeInformationResponseWorkSchedule instance itself
   */
  public EmployeesGetEmployeeInformationResponseWorkSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesGetEmployeeInformationResponseWorkSchedule employeesGetEmployeeInformationResponseWorkSchedule = (EmployeesGetEmployeeInformationResponseWorkSchedule) o;
    return Objects.equals(this.mondayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.mondayWorkingDay) &&
        Objects.equals(this.tuesdayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.tuesdayWorkingDay) &&
        Objects.equals(this.wednesdayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.wednesdayWorkingDay) &&
        Objects.equals(this.thursdayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.thursdayWorkingDay) &&
        Objects.equals(this.fridayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.fridayWorkingDay) &&
        Objects.equals(this.saturdayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.saturdayWorkingDay) &&
        Objects.equals(this.sundayWorkingDay, employeesGetEmployeeInformationResponseWorkSchedule.sundayWorkingDay)&&
        Objects.equals(this.additionalProperties, employeesGetEmployeeInformationResponseWorkSchedule.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mondayWorkingDay, tuesdayWorkingDay, wednesdayWorkingDay, thursdayWorkingDay, fridayWorkingDay, saturdayWorkingDay, sundayWorkingDay, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeesGetEmployeeInformationResponseWorkSchedule {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesGetEmployeeInformationResponseWorkSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesGetEmployeeInformationResponseWorkSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesGetEmployeeInformationResponseWorkSchedule is not found in the empty JSON string", EmployeesGetEmployeeInformationResponseWorkSchedule.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesGetEmployeeInformationResponseWorkSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesGetEmployeeInformationResponseWorkSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesGetEmployeeInformationResponseWorkSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesGetEmployeeInformationResponseWorkSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesGetEmployeeInformationResponseWorkSchedule>() {
           @Override
           public void write(JsonWriter out, EmployeesGetEmployeeInformationResponseWorkSchedule value) throws IOException {
           ...
           @Override
           public EmployeesGetEmployeeInformationResponseWorkSchedule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesGetEmployeeInformationResponseWorkSchedule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesGetEmployeeInformationResponseWorkSchedule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesGetEmployeeInformationResponseWorkSchedule
  * @throws IOException if the JSON string is invalid with respect to EmployeesGetEmployeeInformationResponseWorkSchedule
  */
  public static EmployeesGetEmployeeInformationResponseWorkSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesGetEmployeeInformationResponseWorkSchedule.class);
  }

 /**
  * Convert an instance of EmployeesGetEmployeeInformationResponseWorkSchedule to an JSON string
  *
  * @return JSON string
  */
