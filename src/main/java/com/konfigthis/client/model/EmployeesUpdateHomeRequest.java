...
public class EmployeesUpdateHomeRequest {
  ...
  public EmployeesUpdateHomeRequest() {
  }

  public EmployeesUpdateHomeRequest maritalStatus(String maritalStatus) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest spouseFirstName(String spouseFirstName) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest spouseLastName(String spouseLastName) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest spouseBirthdate(String spouseBirthdate) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest spouseGender(String spouseGender) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest personalEmail(String personalEmail) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest personalPhone(String personalPhone) {
  ...
  **/
  ...
  public EmployeesUpdateHomeRequest personalMobile(String personalMobile) {
  ...
  **/
   ...
   * @return the EmployeesUpdateHomeRequest instance itself
   */
  public EmployeesUpdateHomeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesUpdateHomeRequest employeesUpdateHomeRequest = (EmployeesUpdateHomeRequest) o;
    return Objects.equals(this.maritalStatus, employeesUpdateHomeRequest.maritalStatus) &&
        Objects.equals(this.spouseFirstName, employeesUpdateHomeRequest.spouseFirstName) &&
        Objects.equals(this.spouseLastName, employeesUpdateHomeRequest.spouseLastName) &&
        Objects.equals(this.spouseBirthdate, employeesUpdateHomeRequest.spouseBirthdate) &&
        Objects.equals(this.spouseGender, employeesUpdateHomeRequest.spouseGender) &&
        Objects.equals(this.personalEmail, employeesUpdateHomeRequest.personalEmail) &&
        Objects.equals(this.personalPhone, employeesUpdateHomeRequest.personalPhone) &&
        Objects.equals(this.personalMobile, employeesUpdateHomeRequest.personalMobile)&&
        Objects.equals(this.additionalProperties, employeesUpdateHomeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesUpdateHomeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesUpdateHomeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesUpdateHomeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesUpdateHomeRequest is not found in the empty JSON string", EmployeesUpdateHomeRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesUpdateHomeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesUpdateHomeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesUpdateHomeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesUpdateHomeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesUpdateHomeRequest>() {
           @Override
           public void write(JsonWriter out, EmployeesUpdateHomeRequest value) throws IOException {
           ...
           @Override
           public EmployeesUpdateHomeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesUpdateHomeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesUpdateHomeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesUpdateHomeRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeesUpdateHomeRequest
  */
  public static EmployeesUpdateHomeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesUpdateHomeRequest.class);
  }

 /**
  * Convert an instance of EmployeesUpdateHomeRequest to an JSON string
  *
  * @return JSON string
  */
