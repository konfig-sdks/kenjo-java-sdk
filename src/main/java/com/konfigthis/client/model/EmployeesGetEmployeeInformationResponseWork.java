...
public class EmployeesGetEmployeeInformationResponseWork {
  ...
  public EmployeesGetEmployeeInformationResponseWork() {
  }

  public EmployeesGetEmployeeInformationResponseWork companyId(String companyId) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork officeId(String officeId) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork departmentId(String departmentId) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork startDate(String startDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-07-01T00:00:00.000Z", value = "The starting date of the Kenjo employee in format YYYY-MM-DDThh:mm:ss.")
  ...
  public EmployeesGetEmployeeInformationResponseWork jobTitle(String jobTitle) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork workPhone(String workPhone) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork workMobile(String workMobile) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork isAssistant(Boolean isAssistant) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork probationPeriodEnd(String probationPeriodEnd) {
  ...
  **/
  ...
  public EmployeesGetEmployeeInformationResponseWork reportsToId(String reportsToId) {
  ...
  **/
   ...
   * @return the EmployeesGetEmployeeInformationResponseWork instance itself
   */
  public EmployeesGetEmployeeInformationResponseWork putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesGetEmployeeInformationResponseWork employeesGetEmployeeInformationResponseWork = (EmployeesGetEmployeeInformationResponseWork) o;
    return Objects.equals(this.companyId, employeesGetEmployeeInformationResponseWork.companyId) &&
        Objects.equals(this.officeId, employeesGetEmployeeInformationResponseWork.officeId) &&
        Objects.equals(this.departmentId, employeesGetEmployeeInformationResponseWork.departmentId) &&
        Objects.equals(this.startDate, employeesGetEmployeeInformationResponseWork.startDate) &&
        Objects.equals(this.jobTitle, employeesGetEmployeeInformationResponseWork.jobTitle) &&
        Objects.equals(this.workPhone, employeesGetEmployeeInformationResponseWork.workPhone) &&
        Objects.equals(this.workMobile, employeesGetEmployeeInformationResponseWork.workMobile) &&
        Objects.equals(this.isAssistant, employeesGetEmployeeInformationResponseWork.isAssistant) &&
        Objects.equals(this.probationPeriodEnd, employeesGetEmployeeInformationResponseWork.probationPeriodEnd) &&
        Objects.equals(this.reportsToId, employeesGetEmployeeInformationResponseWork.reportsToId)&&
        Objects.equals(this.additionalProperties, employeesGetEmployeeInformationResponseWork.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companyId, officeId, departmentId, startDate, jobTitle, workPhone, workMobile, isAssistant, probationPeriodEnd, reportsToId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeesGetEmployeeInformationResponseWork {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesGetEmployeeInformationResponseWork
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesGetEmployeeInformationResponseWork.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesGetEmployeeInformationResponseWork is not found in the empty JSON string", EmployeesGetEmployeeInformationResponseWork.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesGetEmployeeInformationResponseWork.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesGetEmployeeInformationResponseWork' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesGetEmployeeInformationResponseWork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesGetEmployeeInformationResponseWork.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesGetEmployeeInformationResponseWork>() {
           @Override
           public void write(JsonWriter out, EmployeesGetEmployeeInformationResponseWork value) throws IOException {
           ...
           @Override
           public EmployeesGetEmployeeInformationResponseWork read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesGetEmployeeInformationResponseWork instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesGetEmployeeInformationResponseWork given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesGetEmployeeInformationResponseWork
  * @throws IOException if the JSON string is invalid with respect to EmployeesGetEmployeeInformationResponseWork
  */
  public static EmployeesGetEmployeeInformationResponseWork fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesGetEmployeeInformationResponseWork.class);
  }

 /**
  * Convert an instance of EmployeesGetEmployeeInformationResponseWork to an JSON string
  *
  * @return JSON string
  */
