...
public class EmployeesCreateInactiveEmployeeResponseWorkSchedule {
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule() {
  }

  public EmployeesCreateInactiveEmployeeResponseWorkSchedule mondayWorkingDay(Boolean mondayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule tuesdayWorkingDay(Boolean tuesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule wednesdayWorkingDay(Boolean wednesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule thursdayWorkingDay(Boolean thursdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule fridayWorkingDay(Boolean fridayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule saturdayWorkingDay(Boolean saturdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule sundayWorkingDay(Boolean sundayWorkingDay) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule trackAttendance(Boolean trackAttendance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "The activation status of attendance tracking for the employee.")
   ...
   * @return the EmployeesCreateInactiveEmployeeResponseWorkSchedule instance itself
   */
  public EmployeesCreateInactiveEmployeeResponseWorkSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesCreateInactiveEmployeeResponseWorkSchedule employeesCreateInactiveEmployeeResponseWorkSchedule = (EmployeesCreateInactiveEmployeeResponseWorkSchedule) o;
    return Objects.equals(this.mondayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.mondayWorkingDay) &&
        Objects.equals(this.tuesdayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.tuesdayWorkingDay) &&
        Objects.equals(this.wednesdayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.wednesdayWorkingDay) &&
        Objects.equals(this.thursdayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.thursdayWorkingDay) &&
        Objects.equals(this.fridayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.fridayWorkingDay) &&
        Objects.equals(this.saturdayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.saturdayWorkingDay) &&
        Objects.equals(this.sundayWorkingDay, employeesCreateInactiveEmployeeResponseWorkSchedule.sundayWorkingDay) &&
        Objects.equals(this.trackAttendance, employeesCreateInactiveEmployeeResponseWorkSchedule.trackAttendance)&&
        Objects.equals(this.additionalProperties, employeesCreateInactiveEmployeeResponseWorkSchedule.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesCreateInactiveEmployeeResponseWorkSchedule {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesCreateInactiveEmployeeResponseWorkSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesCreateInactiveEmployeeResponseWorkSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesCreateInactiveEmployeeResponseWorkSchedule is not found in the empty JSON string", EmployeesCreateInactiveEmployeeResponseWorkSchedule.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesCreateInactiveEmployeeResponseWorkSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesCreateInactiveEmployeeResponseWorkSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesCreateInactiveEmployeeResponseWorkSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesCreateInactiveEmployeeResponseWorkSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesCreateInactiveEmployeeResponseWorkSchedule>() {
           @Override
           public void write(JsonWriter out, EmployeesCreateInactiveEmployeeResponseWorkSchedule value) throws IOException {
           ...
           @Override
           public EmployeesCreateInactiveEmployeeResponseWorkSchedule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesCreateInactiveEmployeeResponseWorkSchedule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesCreateInactiveEmployeeResponseWorkSchedule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesCreateInactiveEmployeeResponseWorkSchedule
  * @throws IOException if the JSON string is invalid with respect to EmployeesCreateInactiveEmployeeResponseWorkSchedule
  */
  public static EmployeesCreateInactiveEmployeeResponseWorkSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesCreateInactiveEmployeeResponseWorkSchedule.class);
  }

 /**
  * Convert an instance of EmployeesCreateInactiveEmployeeResponseWorkSchedule to an JSON string
  *
  * @return JSON string
  */
