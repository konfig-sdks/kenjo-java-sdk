...
public class EmployeesUpdateFinancialsRequest {
  ...
  public EmployeesUpdateFinancialsRequest() {
  }

  public EmployeesUpdateFinancialsRequest accountHolderName(String accountHolderName) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest bankName(String bankName) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest accountNumber(String accountNumber) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest iban(String iban) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest swiftCode(String swiftCode) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest nationalId(String nationalId) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest passport(String passport) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest nationalInsuranceNumber(String nationalInsuranceNumber) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest taxCode(String taxCode) {
  ...
  **/
  ...
  public EmployeesUpdateFinancialsRequest taxIdentificationNumber(String taxIdentificationNumber) {
  ...
  **/
   ...
   * @return the EmployeesUpdateFinancialsRequest instance itself
   */
  public EmployeesUpdateFinancialsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesUpdateFinancialsRequest employeesUpdateFinancialsRequest = (EmployeesUpdateFinancialsRequest) o;
    return Objects.equals(this.accountHolderName, employeesUpdateFinancialsRequest.accountHolderName) &&
        Objects.equals(this.bankName, employeesUpdateFinancialsRequest.bankName) &&
        Objects.equals(this.accountNumber, employeesUpdateFinancialsRequest.accountNumber) &&
        Objects.equals(this.iban, employeesUpdateFinancialsRequest.iban) &&
        Objects.equals(this.swiftCode, employeesUpdateFinancialsRequest.swiftCode) &&
        Objects.equals(this.nationalId, employeesUpdateFinancialsRequest.nationalId) &&
        Objects.equals(this.passport, employeesUpdateFinancialsRequest.passport) &&
        Objects.equals(this.nationalInsuranceNumber, employeesUpdateFinancialsRequest.nationalInsuranceNumber) &&
        Objects.equals(this.taxCode, employeesUpdateFinancialsRequest.taxCode) &&
        Objects.equals(this.taxIdentificationNumber, employeesUpdateFinancialsRequest.taxIdentificationNumber)&&
        Objects.equals(this.additionalProperties, employeesUpdateFinancialsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesUpdateFinancialsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesUpdateFinancialsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesUpdateFinancialsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesUpdateFinancialsRequest is not found in the empty JSON string", EmployeesUpdateFinancialsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesUpdateFinancialsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesUpdateFinancialsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesUpdateFinancialsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesUpdateFinancialsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesUpdateFinancialsRequest>() {
           @Override
           public void write(JsonWriter out, EmployeesUpdateFinancialsRequest value) throws IOException {
           ...
           @Override
           public EmployeesUpdateFinancialsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesUpdateFinancialsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesUpdateFinancialsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesUpdateFinancialsRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeesUpdateFinancialsRequest
  */
  public static EmployeesUpdateFinancialsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesUpdateFinancialsRequest.class);
  }

 /**
  * Convert an instance of EmployeesUpdateFinancialsRequest to an JSON string
  *
  * @return JSON string
  */
