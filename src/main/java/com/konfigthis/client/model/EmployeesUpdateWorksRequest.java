...
public class EmployeesUpdateWorksRequest {
  ...
  public EmployeesUpdateWorksRequest() {
  }

  public EmployeesUpdateWorksRequest companyId(String companyId) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest officeId(String officeId) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest departmentId(String departmentId) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest startDate(String startDate) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest jobTitle(String jobTitle) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest workPhone(String workPhone) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest workMobile(String workMobile) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest isAssistant(Boolean isAssistant) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest probationPeriodEnd(String probationPeriodEnd) {
  ...
  **/
  ...
  public EmployeesUpdateWorksRequest reportsToId(String reportsToId) {
  ...
  **/
   ...
   * @return the EmployeesUpdateWorksRequest instance itself
   */
  public EmployeesUpdateWorksRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesUpdateWorksRequest employeesUpdateWorksRequest = (EmployeesUpdateWorksRequest) o;
    return Objects.equals(this.companyId, employeesUpdateWorksRequest.companyId) &&
        Objects.equals(this.officeId, employeesUpdateWorksRequest.officeId) &&
        Objects.equals(this.departmentId, employeesUpdateWorksRequest.departmentId) &&
        Objects.equals(this.startDate, employeesUpdateWorksRequest.startDate) &&
        Objects.equals(this.jobTitle, employeesUpdateWorksRequest.jobTitle) &&
        Objects.equals(this.workPhone, employeesUpdateWorksRequest.workPhone) &&
        Objects.equals(this.workMobile, employeesUpdateWorksRequest.workMobile) &&
        Objects.equals(this.isAssistant, employeesUpdateWorksRequest.isAssistant) &&
        Objects.equals(this.probationPeriodEnd, employeesUpdateWorksRequest.probationPeriodEnd) &&
        Objects.equals(this.reportsToId, employeesUpdateWorksRequest.reportsToId)&&
        Objects.equals(this.additionalProperties, employeesUpdateWorksRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesUpdateWorksRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesUpdateWorksRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesUpdateWorksRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesUpdateWorksRequest is not found in the empty JSON string", EmployeesUpdateWorksRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesUpdateWorksRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesUpdateWorksRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesUpdateWorksRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesUpdateWorksRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesUpdateWorksRequest>() {
           @Override
           public void write(JsonWriter out, EmployeesUpdateWorksRequest value) throws IOException {
           ...
           @Override
           public EmployeesUpdateWorksRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesUpdateWorksRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesUpdateWorksRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesUpdateWorksRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeesUpdateWorksRequest
  */
  public static EmployeesUpdateWorksRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesUpdateWorksRequest.class);
  }

 /**
  * Convert an instance of EmployeesUpdateWorksRequest to an JSON string
  *
  * @return JSON string
  */
