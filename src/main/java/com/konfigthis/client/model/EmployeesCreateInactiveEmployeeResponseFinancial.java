...
public class EmployeesCreateInactiveEmployeeResponseFinancial {
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial() {
  }

  public EmployeesCreateInactiveEmployeeResponseFinancial accountHolderName(String accountHolderName) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial bankName(String bankName) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial accountNumber(String accountNumber) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial iban(String iban) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial swiftCode(String swiftCode) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial nationalId(String nationalId) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial passport(String passport) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial nationalInsuranceNumber(String nationalInsuranceNumber) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial taxCode(String taxCode) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeResponseFinancial taxIdentificationNumber(String taxIdentificationNumber) {
  ...
  **/
   ...
   * @return the EmployeesCreateInactiveEmployeeResponseFinancial instance itself
   */
  public EmployeesCreateInactiveEmployeeResponseFinancial putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesCreateInactiveEmployeeResponseFinancial employeesCreateInactiveEmployeeResponseFinancial = (EmployeesCreateInactiveEmployeeResponseFinancial) o;
    return Objects.equals(this.accountHolderName, employeesCreateInactiveEmployeeResponseFinancial.accountHolderName) &&
        Objects.equals(this.bankName, employeesCreateInactiveEmployeeResponseFinancial.bankName) &&
        Objects.equals(this.accountNumber, employeesCreateInactiveEmployeeResponseFinancial.accountNumber) &&
        Objects.equals(this.iban, employeesCreateInactiveEmployeeResponseFinancial.iban) &&
        Objects.equals(this.swiftCode, employeesCreateInactiveEmployeeResponseFinancial.swiftCode) &&
        Objects.equals(this.nationalId, employeesCreateInactiveEmployeeResponseFinancial.nationalId) &&
        Objects.equals(this.passport, employeesCreateInactiveEmployeeResponseFinancial.passport) &&
        Objects.equals(this.nationalInsuranceNumber, employeesCreateInactiveEmployeeResponseFinancial.nationalInsuranceNumber) &&
        Objects.equals(this.taxCode, employeesCreateInactiveEmployeeResponseFinancial.taxCode) &&
        Objects.equals(this.taxIdentificationNumber, employeesCreateInactiveEmployeeResponseFinancial.taxIdentificationNumber)&&
        Objects.equals(this.additionalProperties, employeesCreateInactiveEmployeeResponseFinancial.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesCreateInactiveEmployeeResponseFinancial {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesCreateInactiveEmployeeResponseFinancial
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesCreateInactiveEmployeeResponseFinancial.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesCreateInactiveEmployeeResponseFinancial is not found in the empty JSON string", EmployeesCreateInactiveEmployeeResponseFinancial.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesCreateInactiveEmployeeResponseFinancial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesCreateInactiveEmployeeResponseFinancial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesCreateInactiveEmployeeResponseFinancial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesCreateInactiveEmployeeResponseFinancial.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesCreateInactiveEmployeeResponseFinancial>() {
           @Override
           public void write(JsonWriter out, EmployeesCreateInactiveEmployeeResponseFinancial value) throws IOException {
           ...
           @Override
           public EmployeesCreateInactiveEmployeeResponseFinancial read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesCreateInactiveEmployeeResponseFinancial instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesCreateInactiveEmployeeResponseFinancial given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesCreateInactiveEmployeeResponseFinancial
  * @throws IOException if the JSON string is invalid with respect to EmployeesCreateInactiveEmployeeResponseFinancial
  */
  public static EmployeesCreateInactiveEmployeeResponseFinancial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesCreateInactiveEmployeeResponseFinancial.class);
  }

 /**
  * Convert an instance of EmployeesCreateInactiveEmployeeResponseFinancial to an JSON string
  *
  * @return JSON string
  */
