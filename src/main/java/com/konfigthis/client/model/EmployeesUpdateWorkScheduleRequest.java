...
public class EmployeesUpdateWorkScheduleRequest {
  ...
  public EmployeesUpdateWorkScheduleRequest() {
  }

  public EmployeesUpdateWorkScheduleRequest mondayWorkingDay(Boolean mondayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleRequest tuesdayWorkingDay(Boolean tuesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleRequest wednesdayWorkingDay(Boolean wednesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleRequest thursdayWorkingDay(Boolean thursdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleRequest fridayWorkingDay(Boolean fridayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleRequest saturdayWorkingDay(Boolean saturdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleRequest sundayWorkingDay(Boolean sundayWorkingDay) {
  ...
  **/
   ...
   * @return the EmployeesUpdateWorkScheduleRequest instance itself
   */
  public EmployeesUpdateWorkScheduleRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesUpdateWorkScheduleRequest employeesUpdateWorkScheduleRequest = (EmployeesUpdateWorkScheduleRequest) o;
    return Objects.equals(this.mondayWorkingDay, employeesUpdateWorkScheduleRequest.mondayWorkingDay) &&
        Objects.equals(this.tuesdayWorkingDay, employeesUpdateWorkScheduleRequest.tuesdayWorkingDay) &&
        Objects.equals(this.wednesdayWorkingDay, employeesUpdateWorkScheduleRequest.wednesdayWorkingDay) &&
        Objects.equals(this.thursdayWorkingDay, employeesUpdateWorkScheduleRequest.thursdayWorkingDay) &&
        Objects.equals(this.fridayWorkingDay, employeesUpdateWorkScheduleRequest.fridayWorkingDay) &&
        Objects.equals(this.saturdayWorkingDay, employeesUpdateWorkScheduleRequest.saturdayWorkingDay) &&
        Objects.equals(this.sundayWorkingDay, employeesUpdateWorkScheduleRequest.sundayWorkingDay)&&
        Objects.equals(this.additionalProperties, employeesUpdateWorkScheduleRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesUpdateWorkScheduleRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesUpdateWorkScheduleRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesUpdateWorkScheduleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesUpdateWorkScheduleRequest is not found in the empty JSON string", EmployeesUpdateWorkScheduleRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesUpdateWorkScheduleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesUpdateWorkScheduleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesUpdateWorkScheduleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesUpdateWorkScheduleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesUpdateWorkScheduleRequest>() {
           @Override
           public void write(JsonWriter out, EmployeesUpdateWorkScheduleRequest value) throws IOException {
           ...
           @Override
           public EmployeesUpdateWorkScheduleRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesUpdateWorkScheduleRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesUpdateWorkScheduleRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesUpdateWorkScheduleRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeesUpdateWorkScheduleRequest
  */
  public static EmployeesUpdateWorkScheduleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesUpdateWorkScheduleRequest.class);
  }

 /**
  * Convert an instance of EmployeesUpdateWorkScheduleRequest to an JSON string
  *
  * @return JSON string
  */
