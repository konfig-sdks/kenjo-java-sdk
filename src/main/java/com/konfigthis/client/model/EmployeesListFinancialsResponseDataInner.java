...
public class EmployeesListFinancialsResponseDataInner {
  ...
  public EmployeesListFinancialsResponseDataInner() {
  }

  public EmployeesListFinancialsResponseDataInner id(String id) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner accountHolderName(String accountHolderName) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner bankName(String bankName) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner accountNumber(String accountNumber) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner iban(String iban) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner swiftCode(String swiftCode) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner nationalId(String nationalId) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner passport(String passport) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner nationalInsuranceNumber(String nationalInsuranceNumber) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner taxCode(String taxCode) {
  ...
  **/
  ...
  public EmployeesListFinancialsResponseDataInner taxIdentificationNumber(String taxIdentificationNumber) {
  ...
  **/
   ...
   * @return the EmployeesListFinancialsResponseDataInner instance itself
   */
  public EmployeesListFinancialsResponseDataInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesListFinancialsResponseDataInner employeesListFinancialsResponseDataInner = (EmployeesListFinancialsResponseDataInner) o;
    return Objects.equals(this.id, employeesListFinancialsResponseDataInner.id) &&
        Objects.equals(this.accountHolderName, employeesListFinancialsResponseDataInner.accountHolderName) &&
        Objects.equals(this.bankName, employeesListFinancialsResponseDataInner.bankName) &&
        Objects.equals(this.accountNumber, employeesListFinancialsResponseDataInner.accountNumber) &&
        Objects.equals(this.iban, employeesListFinancialsResponseDataInner.iban) &&
        Objects.equals(this.swiftCode, employeesListFinancialsResponseDataInner.swiftCode) &&
        Objects.equals(this.nationalId, employeesListFinancialsResponseDataInner.nationalId) &&
        Objects.equals(this.passport, employeesListFinancialsResponseDataInner.passport) &&
        Objects.equals(this.nationalInsuranceNumber, employeesListFinancialsResponseDataInner.nationalInsuranceNumber) &&
        Objects.equals(this.taxCode, employeesListFinancialsResponseDataInner.taxCode) &&
        Objects.equals(this.taxIdentificationNumber, employeesListFinancialsResponseDataInner.taxIdentificationNumber)&&
        Objects.equals(this.additionalProperties, employeesListFinancialsResponseDataInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesListFinancialsResponseDataInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesListFinancialsResponseDataInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesListFinancialsResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesListFinancialsResponseDataInner is not found in the empty JSON string", EmployeesListFinancialsResponseDataInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesListFinancialsResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesListFinancialsResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesListFinancialsResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesListFinancialsResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesListFinancialsResponseDataInner>() {
           @Override
           public void write(JsonWriter out, EmployeesListFinancialsResponseDataInner value) throws IOException {
           ...
           @Override
           public EmployeesListFinancialsResponseDataInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesListFinancialsResponseDataInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesListFinancialsResponseDataInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesListFinancialsResponseDataInner
  * @throws IOException if the JSON string is invalid with respect to EmployeesListFinancialsResponseDataInner
  */
  public static EmployeesListFinancialsResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesListFinancialsResponseDataInner.class);
  }

 /**
  * Convert an instance of EmployeesListFinancialsResponseDataInner to an JSON string
  *
  * @return JSON string
  */
