...
public class EmployeesListHomesResponseDataInner {
  ...
  public EmployeesListHomesResponseDataInner() {
  }

  public EmployeesListHomesResponseDataInner id(String id) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner maritalStatus(String maritalStatus) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner spouseFirstName(String spouseFirstName) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner spouseLastName(String spouseLastName) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner spouseBirthdate(String spouseBirthdate) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner spouseGender(String spouseGender) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner personalEmail(String personalEmail) {
  ...
  **/
  ...
  public EmployeesListHomesResponseDataInner personalPhone(String personalPhone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4567092324", value = "The employee personal phone.")
  ...
  public EmployeesListHomesResponseDataInner personalMobile(String personalMobile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3567092310", value = "The employee personal mobile.")
   ...
   * @return the EmployeesListHomesResponseDataInner instance itself
   */
  public EmployeesListHomesResponseDataInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesListHomesResponseDataInner employeesListHomesResponseDataInner = (EmployeesListHomesResponseDataInner) o;
    return Objects.equals(this.id, employeesListHomesResponseDataInner.id) &&
        Objects.equals(this.maritalStatus, employeesListHomesResponseDataInner.maritalStatus) &&
        Objects.equals(this.spouseFirstName, employeesListHomesResponseDataInner.spouseFirstName) &&
        Objects.equals(this.spouseLastName, employeesListHomesResponseDataInner.spouseLastName) &&
        Objects.equals(this.spouseBirthdate, employeesListHomesResponseDataInner.spouseBirthdate) &&
        Objects.equals(this.spouseGender, employeesListHomesResponseDataInner.spouseGender) &&
        Objects.equals(this.personalEmail, employeesListHomesResponseDataInner.personalEmail) &&
        Objects.equals(this.personalPhone, employeesListHomesResponseDataInner.personalPhone) &&
        Objects.equals(this.personalMobile, employeesListHomesResponseDataInner.personalMobile)&&
        Objects.equals(this.additionalProperties, employeesListHomesResponseDataInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, maritalStatus, spouseFirstName, spouseLastName, spouseBirthdate, spouseGender, personalEmail, personalPhone, personalMobile, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeesListHomesResponseDataInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesListHomesResponseDataInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesListHomesResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesListHomesResponseDataInner is not found in the empty JSON string", EmployeesListHomesResponseDataInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesListHomesResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesListHomesResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesListHomesResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesListHomesResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesListHomesResponseDataInner>() {
           @Override
           public void write(JsonWriter out, EmployeesListHomesResponseDataInner value) throws IOException {
           ...
           @Override
           public EmployeesListHomesResponseDataInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesListHomesResponseDataInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesListHomesResponseDataInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesListHomesResponseDataInner
  * @throws IOException if the JSON string is invalid with respect to EmployeesListHomesResponseDataInner
  */
  public static EmployeesListHomesResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesListHomesResponseDataInner.class);
  }

 /**
  * Convert an instance of EmployeesListHomesResponseDataInner to an JSON string
  *
  * @return JSON string
  */
