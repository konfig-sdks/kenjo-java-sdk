...
public class EmployeesCreateInactiveEmployeeRequestHome {
  ...
  public EmployeesCreateInactiveEmployeeRequestHome() {
  }

  public EmployeesCreateInactiveEmployeeRequestHome maritalStatus(String maritalStatus) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome spouseFirstName(String spouseFirstName) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome spouseLastName(String spouseLastName) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome spouseBirthdate(String spouseBirthdate) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome spouseGender(String spouseGender) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome personalEmail(String personalEmail) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome personalPhone(String personalPhone) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestHome personalMobile(String personalMobile) {
  ...
  **/
   ...
   * @return the EmployeesCreateInactiveEmployeeRequestHome instance itself
   */
  public EmployeesCreateInactiveEmployeeRequestHome putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesCreateInactiveEmployeeRequestHome employeesCreateInactiveEmployeeRequestHome = (EmployeesCreateInactiveEmployeeRequestHome) o;
    return Objects.equals(this.maritalStatus, employeesCreateInactiveEmployeeRequestHome.maritalStatus) &&
        Objects.equals(this.spouseFirstName, employeesCreateInactiveEmployeeRequestHome.spouseFirstName) &&
        Objects.equals(this.spouseLastName, employeesCreateInactiveEmployeeRequestHome.spouseLastName) &&
        Objects.equals(this.spouseBirthdate, employeesCreateInactiveEmployeeRequestHome.spouseBirthdate) &&
        Objects.equals(this.spouseGender, employeesCreateInactiveEmployeeRequestHome.spouseGender) &&
        Objects.equals(this.personalEmail, employeesCreateInactiveEmployeeRequestHome.personalEmail) &&
        Objects.equals(this.personalPhone, employeesCreateInactiveEmployeeRequestHome.personalPhone) &&
        Objects.equals(this.personalMobile, employeesCreateInactiveEmployeeRequestHome.personalMobile)&&
        Objects.equals(this.additionalProperties, employeesCreateInactiveEmployeeRequestHome.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesCreateInactiveEmployeeRequestHome {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesCreateInactiveEmployeeRequestHome
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesCreateInactiveEmployeeRequestHome.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesCreateInactiveEmployeeRequestHome is not found in the empty JSON string", EmployeesCreateInactiveEmployeeRequestHome.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesCreateInactiveEmployeeRequestHome.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesCreateInactiveEmployeeRequestHome' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesCreateInactiveEmployeeRequestHome> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesCreateInactiveEmployeeRequestHome.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesCreateInactiveEmployeeRequestHome>() {
           @Override
           public void write(JsonWriter out, EmployeesCreateInactiveEmployeeRequestHome value) throws IOException {
           ...
           @Override
           public EmployeesCreateInactiveEmployeeRequestHome read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesCreateInactiveEmployeeRequestHome instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesCreateInactiveEmployeeRequestHome given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesCreateInactiveEmployeeRequestHome
  * @throws IOException if the JSON string is invalid with respect to EmployeesCreateInactiveEmployeeRequestHome
  */
  public static EmployeesCreateInactiveEmployeeRequestHome fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesCreateInactiveEmployeeRequestHome.class);
  }

 /**
  * Convert an instance of EmployeesCreateInactiveEmployeeRequestHome to an JSON string
  *
  * @return JSON string
  */
