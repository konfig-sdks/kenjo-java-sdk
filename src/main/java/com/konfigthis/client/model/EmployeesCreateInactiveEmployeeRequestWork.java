...
public class EmployeesCreateInactiveEmployeeRequestWork {
  ...
  public EmployeesCreateInactiveEmployeeRequestWork() {
  }

  public EmployeesCreateInactiveEmployeeRequestWork companyId(String companyId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "50a2db290da29e126a187894", required = true, value = "The company id of the Kenjo employee. This field is required and must to match with Kenjo _id of an existing company.")
  ...
  public EmployeesCreateInactiveEmployeeRequestWork officeId(String officeId) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork departmentId(String departmentId) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork startDate(String startDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-01-01T00:00:00.000Z", value = "The starting date of the employee. Format YYYY-MM-DDThh:mm:ss.000Z.")
  ...
  public EmployeesCreateInactiveEmployeeRequestWork jobTitle(String jobTitle) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork workPhone(String workPhone) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork workMobile(String workMobile) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork isAssistant(Boolean isAssistant) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork probationPeriodEnd(String probationPeriodEnd) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork reportsToId(String reportsToId) {
  ...
  **/
  ...
  public EmployeesCreateInactiveEmployeeRequestWork weeklyHours(Double weeklyHours) {
  ...
  public EmployeesCreateInactiveEmployeeRequestWork weeklyHours(Integer weeklyHours) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "40", required = true, value = "The number of weekly hours that an employee works. Combined with the work schedule allows to determine the day hours. This field is required and must be equals or greater than 1.")
   ...
   * @return the EmployeesCreateInactiveEmployeeRequestWork instance itself
   */
  public EmployeesCreateInactiveEmployeeRequestWork putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesCreateInactiveEmployeeRequestWork employeesCreateInactiveEmployeeRequestWork = (EmployeesCreateInactiveEmployeeRequestWork) o;
    return Objects.equals(this.companyId, employeesCreateInactiveEmployeeRequestWork.companyId) &&
        Objects.equals(this.officeId, employeesCreateInactiveEmployeeRequestWork.officeId) &&
        Objects.equals(this.departmentId, employeesCreateInactiveEmployeeRequestWork.departmentId) &&
        Objects.equals(this.startDate, employeesCreateInactiveEmployeeRequestWork.startDate) &&
        Objects.equals(this.jobTitle, employeesCreateInactiveEmployeeRequestWork.jobTitle) &&
        Objects.equals(this.workPhone, employeesCreateInactiveEmployeeRequestWork.workPhone) &&
        Objects.equals(this.workMobile, employeesCreateInactiveEmployeeRequestWork.workMobile) &&
        Objects.equals(this.isAssistant, employeesCreateInactiveEmployeeRequestWork.isAssistant) &&
        Objects.equals(this.probationPeriodEnd, employeesCreateInactiveEmployeeRequestWork.probationPeriodEnd) &&
        Objects.equals(this.reportsToId, employeesCreateInactiveEmployeeRequestWork.reportsToId) &&
        Objects.equals(this.weeklyHours, employeesCreateInactiveEmployeeRequestWork.weeklyHours)&&
        Objects.equals(this.additionalProperties, employeesCreateInactiveEmployeeRequestWork.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeesCreateInactiveEmployeeRequestWork {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("weeklyHours");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesCreateInactiveEmployeeRequestWork
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesCreateInactiveEmployeeRequestWork.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesCreateInactiveEmployeeRequestWork is not found in the empty JSON string", EmployeesCreateInactiveEmployeeRequestWork.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeesCreateInactiveEmployeeRequestWork.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesCreateInactiveEmployeeRequestWork.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesCreateInactiveEmployeeRequestWork' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesCreateInactiveEmployeeRequestWork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesCreateInactiveEmployeeRequestWork.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesCreateInactiveEmployeeRequestWork>() {
           @Override
           public void write(JsonWriter out, EmployeesCreateInactiveEmployeeRequestWork value) throws IOException {
           ...
           @Override
           public EmployeesCreateInactiveEmployeeRequestWork read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesCreateInactiveEmployeeRequestWork instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesCreateInactiveEmployeeRequestWork given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesCreateInactiveEmployeeRequestWork
  * @throws IOException if the JSON string is invalid with respect to EmployeesCreateInactiveEmployeeRequestWork
  */
  public static EmployeesCreateInactiveEmployeeRequestWork fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesCreateInactiveEmployeeRequestWork.class);
  }

 /**
  * Convert an instance of EmployeesCreateInactiveEmployeeRequestWork to an JSON string
  *
  * @return JSON string
  */
