...
public class EmployeesUpdateWorkScheduleResponse {
  ...
  public EmployeesUpdateWorkScheduleResponse() {
  }

  public EmployeesUpdateWorkScheduleResponse id(String id) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleResponse mondayWorkingDay(Boolean mondayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleResponse tuesdayWorkingDay(Boolean tuesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleResponse wednesdayWorkingDay(Boolean wednesdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleResponse thursdayWorkingDay(Boolean thursdayWorkingDay) {
  ...
  **/
  ...
  public EmployeesUpdateWorkScheduleResponse fridayWorkingDay(Boolean fridayWorkingDay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Allow to indicate if fridays are working days for the employee.")
  ...
  public EmployeesUpdateWorkScheduleResponse saturdayWorkingDay(Boolean saturdayWorkingDay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Allow to indicate if saturdays are working days for the employee.")
  ...
  public EmployeesUpdateWorkScheduleResponse sundayWorkingDay(Boolean sundayWorkingDay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Allow to indicate if sundays are working days for the employee.")
   ...
   * @return the EmployeesUpdateWorkScheduleResponse instance itself
   */
  public EmployeesUpdateWorkScheduleResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesUpdateWorkScheduleResponse employeesUpdateWorkScheduleResponse = (EmployeesUpdateWorkScheduleResponse) o;
    return Objects.equals(this.id, employeesUpdateWorkScheduleResponse.id) &&
        Objects.equals(this.mondayWorkingDay, employeesUpdateWorkScheduleResponse.mondayWorkingDay) &&
        Objects.equals(this.tuesdayWorkingDay, employeesUpdateWorkScheduleResponse.tuesdayWorkingDay) &&
        Objects.equals(this.wednesdayWorkingDay, employeesUpdateWorkScheduleResponse.wednesdayWorkingDay) &&
        Objects.equals(this.thursdayWorkingDay, employeesUpdateWorkScheduleResponse.thursdayWorkingDay) &&
        Objects.equals(this.fridayWorkingDay, employeesUpdateWorkScheduleResponse.fridayWorkingDay) &&
        Objects.equals(this.saturdayWorkingDay, employeesUpdateWorkScheduleResponse.saturdayWorkingDay) &&
        Objects.equals(this.sundayWorkingDay, employeesUpdateWorkScheduleResponse.sundayWorkingDay)&&
        Objects.equals(this.additionalProperties, employeesUpdateWorkScheduleResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, mondayWorkingDay, tuesdayWorkingDay, wednesdayWorkingDay, thursdayWorkingDay, fridayWorkingDay, saturdayWorkingDay, sundayWorkingDay, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeesUpdateWorkScheduleResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesUpdateWorkScheduleResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesUpdateWorkScheduleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesUpdateWorkScheduleResponse is not found in the empty JSON string", EmployeesUpdateWorkScheduleResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesUpdateWorkScheduleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesUpdateWorkScheduleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesUpdateWorkScheduleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesUpdateWorkScheduleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesUpdateWorkScheduleResponse>() {
           @Override
           public void write(JsonWriter out, EmployeesUpdateWorkScheduleResponse value) throws IOException {
           ...
           @Override
           public EmployeesUpdateWorkScheduleResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesUpdateWorkScheduleResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesUpdateWorkScheduleResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesUpdateWorkScheduleResponse
  * @throws IOException if the JSON string is invalid with respect to EmployeesUpdateWorkScheduleResponse
  */
  public static EmployeesUpdateWorkScheduleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesUpdateWorkScheduleResponse.class);
  }

 /**
  * Convert an instance of EmployeesUpdateWorkScheduleResponse to an JSON string
  *
  * @return JSON string
  */
