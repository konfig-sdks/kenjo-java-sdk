...
public class EmployeesListWorksResponseDataInner {
  ...
  public EmployeesListWorksResponseDataInner() {
  }

  public EmployeesListWorksResponseDataInner id(String id) {
  ...
  **/
  ...
  public EmployeesListWorksResponseDataInner companyId(String companyId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The company id of the Kenjo employee.")
  ...
  public EmployeesListWorksResponseDataInner officeId(String officeId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The office id of the Kenjo employee.")
  ...
  public EmployeesListWorksResponseDataInner departmentId(String departmentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The department id of the Kenjo employee.")
  ...
  public EmployeesListWorksResponseDataInner startDate(String startDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The starting date of the Kenjo employee in format YYYY-MM-DDThh:mm:ss.")
  ...
  public EmployeesListWorksResponseDataInner jobTitle(String jobTitle) {
  ...
  **/
  ...
  public EmployeesListWorksResponseDataInner workPhone(String workPhone) {
  ...
  **/
  ...
  public EmployeesListWorksResponseDataInner workMobile(String workMobile) {
  ...
  **/
  ...
  public EmployeesListWorksResponseDataInner isAssistant(Boolean isAssistant) {
  ...
  **/
  ...
  public EmployeesListWorksResponseDataInner probationPeriodEnd(String probationPeriodEnd) {
  ...
  **/
  ...
  public EmployeesListWorksResponseDataInner reportsToId(String reportsToId) {
  ...
  **/
   ...
   * @return the EmployeesListWorksResponseDataInner instance itself
   */
  public EmployeesListWorksResponseDataInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesListWorksResponseDataInner employeesListWorksResponseDataInner = (EmployeesListWorksResponseDataInner) o;
    return Objects.equals(this.id, employeesListWorksResponseDataInner.id) &&
        Objects.equals(this.companyId, employeesListWorksResponseDataInner.companyId) &&
        Objects.equals(this.officeId, employeesListWorksResponseDataInner.officeId) &&
        Objects.equals(this.departmentId, employeesListWorksResponseDataInner.departmentId) &&
        Objects.equals(this.startDate, employeesListWorksResponseDataInner.startDate) &&
        Objects.equals(this.jobTitle, employeesListWorksResponseDataInner.jobTitle) &&
        Objects.equals(this.workPhone, employeesListWorksResponseDataInner.workPhone) &&
        Objects.equals(this.workMobile, employeesListWorksResponseDataInner.workMobile) &&
        Objects.equals(this.isAssistant, employeesListWorksResponseDataInner.isAssistant) &&
        Objects.equals(this.probationPeriodEnd, employeesListWorksResponseDataInner.probationPeriodEnd) &&
        Objects.equals(this.reportsToId, employeesListWorksResponseDataInner.reportsToId)&&
        Objects.equals(this.additionalProperties, employeesListWorksResponseDataInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, officeId, departmentId, startDate, jobTitle, workPhone, workMobile, isAssistant, probationPeriodEnd, reportsToId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeesListWorksResponseDataInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesListWorksResponseDataInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesListWorksResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesListWorksResponseDataInner is not found in the empty JSON string", EmployeesListWorksResponseDataInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesListWorksResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesListWorksResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesListWorksResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesListWorksResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesListWorksResponseDataInner>() {
           @Override
           public void write(JsonWriter out, EmployeesListWorksResponseDataInner value) throws IOException {
           ...
           @Override
           public EmployeesListWorksResponseDataInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesListWorksResponseDataInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesListWorksResponseDataInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesListWorksResponseDataInner
  * @throws IOException if the JSON string is invalid with respect to EmployeesListWorksResponseDataInner
  */
  public static EmployeesListWorksResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesListWorksResponseDataInner.class);
  }

 /**
  * Convert an instance of EmployeesListWorksResponseDataInner to an JSON string
  *
  * @return JSON string
  */
